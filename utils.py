...
def train_one_epoch(model, data_loader, loss_fn1, loss_fn2, optimizer, epoch_no, device, verbose = 1):
    ...
    for feed_dict in data_loader:
        ...
        loss = 0.5*loss_fn1(prediction, rating) + 0.5*loss_fn2(prediction, rating)
        # clear the gradients
        optimizer.zero_grad()
        # backpropagate
        loss.backward()
